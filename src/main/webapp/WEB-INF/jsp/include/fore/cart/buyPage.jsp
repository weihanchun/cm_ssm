...
<div class="buyPageDiv">
  <form action="forecreateOrder" method="post">
	...
	<div class="address">
		<div class="addressTip">输入收货人信息</div>
		<div>
		
			<table class="addressTable">
				<tr>
					<td class="firstColumn">收货地址<span class="redStar">*</span></td>
						<td>
						<textarea name="address" text-align="left" placeholder="建议您如实填写详细收货地址，例如接到名称，门牌好吗，楼层和房间号等信息">${address.province} ${address.city} ${address.county} ${address.town} ${address.street}
						</textarea>
					   </td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input  name="receiver" value="${user.name}"  placeholder="长度不超过25个字符" type="text"></td>
				</tr>
				<tr>
					<td>手机号码 <span class="redStar">*</span></td>
					<td><input name="mobile" value="${user.phone}" placeholder="请输入11位手机号码" type="text"></td>
				</tr>
			</table>
		</div>
	</div>
			...
			<thead>
				<tr>
					<th colspan="2" class="productListTableFirstColumn">
						<a class="marketLink" href="#nowhere">店铺：此木花店</a>
					</th>
					<th>单价</th>
					<th>数量</th>
					<th>小计</th>
